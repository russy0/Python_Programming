...
print(s.find('Jave'))  # 인덱스 반환 ( 없으면 -1 반환)
# print(s.index('Jave'))  # 인덱스 반환 ( 없으면 에러)
...
# 문제) replace는 원본 문자열을 바꿀까요? 새로운 문자열을 만들까요? => 새로운 문자열 생성
print(s.replace("Python", "C"))  # 전체 치환
print(s.replace("Python", "C", 1))  # 1개만 치환

# 판별 문자열 메소드 (isXXX())
print("123".isdigit())  # 숫자이면 True (음수, 소수는 안됨)
